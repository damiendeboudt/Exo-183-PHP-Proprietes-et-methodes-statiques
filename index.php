 ...
 *    - Créez une propriété statique qui contiendra le nombre total d'abonnés de la plateforme ( total d'abonnés
 * VOD dans le cas de la classe mère )
 *    - Définissez vos setters et vos getters.
 *    - Créez en plus une méthode statique permettant de mettre à jour la propriété statique du nombre total
 * d'abonnés sur TOUTES les plateformes. ( addAbo() ou je ne sais quoi )
...
echo $netflix::getAbo() . '<br>';
echo $prime::getAbo() . '<br>';
...
echo 'abo total = ' . $prime::getAboAfterAdd() . '<br>';
